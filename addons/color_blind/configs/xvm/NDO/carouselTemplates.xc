{
  "normal": {
    ...
    "extraFields": [
      ...
      { "x": 3, "y": 70, "width": 26, "height": 28, "src": "{{v.mastery!=0?img://gui/maps/icons/achievement/markOfMastery{{v.mastery}}.png}}" },
      ...
      { "hotKeyCode": 56, "onHold": true, "visibleOnHotKey": false, "x": 160, "y": 52, "align": "right", "format": "<font face='$FieldFont' color='#DDDDDD'>{{v.marksOnGun}}</font>", "shadow": { "enabled": true, "distance": 0, "angle": 0, "color": "0x000000", "alpha": 80, "blur": 3, "strength": 4 } },
      ...
      { "hotKeyCode": 56, "onHold": true, "visibleOnHotKey": false, "x": 158, "y": 80, "align": "right", "format": "<font face='$FieldFont' size='13' color='{{v.premium?#FFAA55|{{v.special?#6FA500|#DDDDDD}}}}'><b>{{v.name}}</b></font>", "shadow": { "enabled": true, "distance": 0, "angle": 0, "color": "{{v.premium?0xFF4400|0x4C4C4C}}", "alpha": 80, "blur": 4, "strength": 2 } },
  ...
  "small": {
    ...
    "extraFields": [
      ...
      { "x": 158, "y": 16, "align": "right", "format": "<font face='$FieldFont' size='13' color='{{v.premium?#FFAA55|{{v.special?#6FA500|#DDDDDD}}}}'><b>{{v.name}}</b></font>", "shadow": { "enabled": true, "distance": 0, "angle": 0, "color": "{{v.premium?0xFF4400|0x4C4C4C}}", "alpha": 80, "blur": 4, "strength": 2 } },
