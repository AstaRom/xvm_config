{
  "normal": {
    ...
    "extraFields": [
      ...
      { "hotKeyCode": 56, "onHold": true, "visibleOnHotKey": false, "x": 3, "y": 70, "width": 26, "height": 28, "src": "{{v.mastery!=0?img://gui/maps/icons/achievement/markOfMastery{{v.mastery}}.png}}" },
      { "hotKeyCode": 56, "onHold": true, "visibleOnHotKey": true, "x": 3, "y": 70, "width": 28, "height": 28, "src": "{{v.crystalEarned!=100?img://gui/maps/icons/library/crystal_48x48.png}}" },
