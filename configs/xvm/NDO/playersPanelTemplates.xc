{
  ...
  "shortLeft": [
    { "x": 0, "y": 0, "w": 56, "h": 24, "valign": "center", "src": "cfg://NDO/img/playersPanel/{{player?player|{{ready?{{squad?squad|ready}}|a-noready}}}}.png", "alpha": "{{alive?35|0}}" },
    { "x": 40, "y": 0, "align": "center", "valign": "center", "format": "<font size='14'><b><font color='{{player?#FFB964|{{squad?{{c:system}}|{{tk?{{c:system}}}}}}}}'>{{frags|0}}</font></b></font>", "alpha": "{{alive?100|50}}", "shadow": { "distance": 0, "angle": 90, "color": "0x000000", "alpha": 80, "blur": 2, "strength": 2 } },
    ...
    { "enabled": ${"@settings.xc":"settings.playersPanel.hp_panels.short"}, "x": 102, "y": 4, "bindToIcon": true, "valign": "center", "w": "{{hp-ratio:56}}", "h": 18, "bgColor": "{{player?#FFB964|{{c:system}}}}", "alpha": "{{alive?50|0}}" },
  ...
  "shortRight": [
    { "x": 0, "y": 0, "w": 56, "h": 24, "valign": "center", "src": "cfg://NDO/img/playersPanel/{{ready?ready|e-noready}}.png", "alpha": "{{alive?35|0}}" },
  ...
  "mediumLeft": [
    { "x": 0, "y": 0, "w": 173, "h": 24, "valign": "center", "src": "cfg://NDO/img/playersPanel/{{player?player|{{ready?{{squad?squad|ready}}|a-noready}}}}.png", "alpha": "{{alive?35|0}}" },
    { "x": 40, "y": 0, "align": "center", "valign": "center", "format": "<font size='14'><b><font color='{{player?#FFB964|{{squad?{{c:system}}|{{tk?{{c:system}}}}}}}}'>{{frags|0}}</font></b></font>", "alpha": "{{alive?100|50}}", "shadow": { "distance": 0, "angle": 90, "color": "0x000000", "alpha": 80, "blur": 2, "strength": 2 } },
    ...
    { "enabled": ${"@settings.xc":"settings.playersPanel.hp_panels.medium"}, "x": 102, "y": 4, "bindToIcon": true, "valign": "center", "w": "{{hp-ratio:56}}", "h": 18, "bgColor": "{{player?#FFB964|{{c:system}}}}", "alpha": "{{alive?50|0}}" },
  ...
  "mediumRight": [
    { "x": 0, "y": 0, "w": 173, "h": 24, "valign": "center", "src": "cfg://NDO/img/playersPanel/{{ready?ready|e-noready}}.png", "alpha": "{{alive?35|0}}" },
    { "x": 40, "y": 0,"align": "center", "valign": "center", "format": "<font size='14'><b><font color='{{tk?#00EAFF}}'>{{frags|0}}</font></b></font>", "alpha": "{{alive?100|50}}", "shadow": { "distance": 0, "angle": 90, "color": "0x000000", "alpha": 80, "blur": 2, "strength": 2 } },
  ...
  "medium2Left": [
    { "x": 0, "y": 0, "w": "{{xvm-stat?141|138}}", "h": 24, "valign": "center", "src": "cfg://NDO/img/playersPanel/{{player?player|{{ready?{{squad?squad|ready}}|a-noready}}}}.png", "alpha": "{{alive?35|0}}" },
    { "x": 40, "y": 0, "align": "center", "valign": "center", "format": "<font size='14'><b><font color='{{player?#FFB964|{{squad?{{c:system}}|{{tk?{{c:system}}}}}}}}'>{{frags|0}}</font></b></font>", "alpha": "{{alive?100|50}}", "shadow": { "distance": 0, "angle": 90, "color": "0x000000", "alpha": 80, "blur": 2, "strength": 2 } },
    ...
    { "enabled": ${"@settings.xc":"settings.playersPanel.hp_panels.medium2"}, "x": 102, "y": 4, "bindToIcon": true, "valign": "center", "w": "{{hp-ratio:56}}", "h": 18, "bgColor": "{{player?#FFB964|{{c:system}}}}", "alpha": "{{alive?50|0}}" },
  ...
  "medium2Right": [
    { "x": 0, "y": 0, "w": "{{xvm-stat?141|138}}", "h": 24, "valign": "center", "src": "cfg://NDO/img/playersPanel/{{ready?ready|e-noready}}.png", "alpha": "{{alive?35|0}}" },
    { "x": 40, "y": 0,"align": "center", "valign": "center", "format": "<font size='14'><b><font color='{{tk?#00EAFF}}'>{{frags|0}}</font></b></font>", "alpha": "{{alive?100|50}}", "shadow": { "distance": 0, "angle": 90, "color": "0x000000", "alpha": 80, "blur": 2, "strength": 2 } },
  ...
  "largeLeft": [
    { "x": 0, "y": 0, "w": "{{xvm-stat?181|238}}", "h": 24, "valign": "center", "src": "cfg://NDO/img/playersPanel/{{player?player|{{ready?{{squad?squad|ready}}|a-noready}}}}.png", "alpha": "{{alive?35|0}}" },
    { "x": 40, "y": 0, "align": "center", "valign": "center", "format": "<font size='14'><b><font color='{{player?#FFB964|{{squad?{{c:system}}|{{tk?{{c:system}}}}}}}}'>{{frags|0}}</font></b></font>", "alpha": "{{alive?100|50}}", "shadow": { "distance": 0, "angle": 90, "color": "0x000000", "alpha": 80, "blur": 2, "strength": 2 } },
    ...
    { "enabled": ${"@settings.xc":"settings.playersPanel.hp_panels.large"}, "x": 102, "y": 4, "bindToIcon": true, "valign": "center", "w": "{{hp-ratio:56}}", "h": 18, "bgColor": "{{player?#FFB964|{{c:system}}}}", "alpha": "{{alive?50|0}}" },
  ...
  "largeRight": [
    { "x": 0, "y": 0, "w": "{{xvm-stat?181|238}}", "h": 24, "valign": "center", "src": "cfg://NDO/img/playersPanel/{{ready?ready|e-noready}}.png", "alpha": "{{alive?35|0}}" },
    { "x": 40, "y": 0,"align": "center", "valign": "center", "format": "<font size='14'><b><font color='{{tk?#00EAFF}}'>{{frags|0}}</font></b></font>", "alpha": "{{alive?100|50}}", "shadow": { "distance": 0, "angle": 90, "color": "0x000000", "alpha": 80, "blur": 2, "strength": 2 } },
