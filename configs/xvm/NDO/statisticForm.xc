{
  "statisticForm": {
    ...
    "nameFieldWidthRight": "{{xvm-stat?161|169}}",
    "vehicleFieldOffsetXLeft": 80,
    "vehicleFieldOffsetXRight": 62,
    "vehicleFieldWidthLeft": "{{xvm-stat?163|170}}",
    "vehicleFieldWidthRight": "{{xvm-stat?163|170}}",
    ...
    "extraFieldsLeft": [
      { "enabled": "{{xvm-stat?true|false}}", "x": 23, "y": 1, "width": 15, "height": 24, "align": "center", "textFormat": { "valign": "center" }, "format": "<font face='NDO' size='{{xvm-stat?16|0}}' color='{{x-enabled?#96FF00|{{xvm-user=on?#FF8800|{{xvm-user=off?#AAAAAA}}}}}}'>{{xvm-user=on?&#x004E;|{{xvm-user=off?&#x004E;}}}}</font>", "alpha": "{{alive?100|50}}", "shadow": { "enabled": true, "distance": 0, "angle": 90, "color": "0x000000", "alpha": 80, "blur": 2, "strength": 2 } }
    ],
    "extraFieldsRight": [
